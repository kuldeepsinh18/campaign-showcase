      ...
      <main className={`relative bg-black min-h-screen selection:bg-white selection:text-black ${isLoading ? 'h-screen overflow-hidden' : ''}`}>
        ...
        <section className="relative z-20 px-4 md:px-8 lg:px-12 pb-24 pt-8 bg-black min-h-[50vh]">
          ...
          <div className="max-w-[1600px] mx-auto relative">
            <motion.div
              className="columns-1 md:columns-2 lg:columns-3 xl:columns-4 gap-4 md:gap-6 lg:gap-8 space-y-4 md:space-y-6 lg:space-y-8"
              initial={{ opacity: 0 }}
              ...
              {campaign.media.map((item, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`relative w-full ${aspectClass} rounded-xl md:rounded-2xl transition-all duration-500 break-inside-avoid ${
