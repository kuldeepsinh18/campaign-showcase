            ...
            <div className="flex flex-col md:flex-row justify-between gap-16 md:gap-8">
              ...
              >
                <div className="flex items-center gap-2.5 mb-2">
                  ...
                  <h3 className="text-xs font-mono text-neutral-500 uppercase tracking-widest">WhatsApp</h3>
                </div>
              ...
              >
                <div className="flex items-center gap-2.5 mb-2">
                  ...
                  <h3 className="text-xs font-mono text-neutral-500 uppercase tracking-widest">Email</h3>
                </div>
              ...
              >
                <div className="flex items-center gap-2.5 mb-2">
                  ...
                  <h3 className="text-xs font-mono text-neutral-500 uppercase tracking-widest">Call</h3>
                </div>
